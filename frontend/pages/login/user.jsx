                ...
                >
                    <div className="flex w-80 flex-col items-center gap-y-2 rounded-lg bg-white py-2 pt-8 shadow">
                        ...
                        hover:border-gray-400"/>
                            ...
                            <div className="my-6">
                                <button onClick={handleLogin} type="button" className="text-md text-white block px-3 py-2.5 rounded-lg w-full bg-blue-500 shadow-md
                        hover:bg-blue-600
                        focus:bg-blue-700">
                                    <span>Log in</span>
                                </button>
                    ...
                    <div className="flex w-80 flex-row justify-between gap-x-4">
                        ...
                        <a href="/register/user" onClick={()=>setIsShowing(false)} className="flex items-center justify-center flex-1 space-x-1 rounded-lg bg-white py-4 text-center text-base font-bold shadow text-violet-500 hover:text-violet-700">
